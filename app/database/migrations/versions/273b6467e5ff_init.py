...
def upgrade() -> None:
    ...
    op.create_table(
        "starred_messages",
        sa.Column("starred_message_id", mysql.BIGINT(unsigned=True), autoincrement=True, nullable=False),
    ...
    op.create_table(
        "xp_boosts",
        sa.Column("role_id", mysql.BIGINT(unsigned=True), autoincrement=True, nullable=False),
