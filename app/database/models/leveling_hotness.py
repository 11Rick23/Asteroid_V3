...
class LevelingHotnessEventModel(Base):
    ...
    __table_args__ = (Index("idx_leveling_hotness_events_earned_at_user_id", "earned_at", "user_id"),)
    ...
    earned_at: Mapped[datetime] = mapped_column(DateTime, nullable=False, server_default=text("CURRENT_TIMESTAMP"))
