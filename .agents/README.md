...
| `asteroid-v3-test-guideline` | pytest layout by tested contract, test case design techniques, Given-When-Then style, Japanese docstring specs, fake Discord objects, permission tests, guild-scope tests, service/repository tests, and caplog. |
